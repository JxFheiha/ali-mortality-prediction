...
df1 = pd.read_csv("E:/ML/ALI-stroke/pythonML/202508revise/stroke-shapdata.csv", encoding='gbk')
data=df1
# GBM建模数据准备=====================================================
# 第一列为输出结果
...
shap.save_html("Stroke-force_plot_one-1.html", force_plot_one)



# summarize the effects of all the features
shap.summary_plot(shap_values[1], test_x,show=False)#max_display=10,
plt.savefig('Stroke-shapsummary.pdf', bbox_inches="tight",dpi=300)
plt.clf()
plt.close()

shap.summary_plot(shap_values, test_x, plot_type="bar", show=False)
plt.savefig('Stroke-shap柱状.pdf', bbox_inches='tight', dpi=300)
